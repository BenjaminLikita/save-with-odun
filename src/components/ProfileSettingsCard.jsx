  ...
  return (
    <div>
      <form action="" className='flex flex-col gap-5 my-3'>
        <div>
          <label htmlFor="" className='block text-sm lg:text-lg font-semibold py-1'>Your Avatar</label>
        ...
        <div>
          <label htmlFor="" className='block text-sm lg:text-lg font-semibold py-1'>First Name</label>
          <input type="text" name='first-name' className='bg-theme-light px-3 py-2 rounded-lg w-full focus:outline-none' />
        </div>
        <div>
          <label htmlFor="" className='block text-sm lg:text-lg font-semibold py-1'>Other Names</label>
          <input type="text" name='otherNames' className='bg-theme-light px-3 py-2 rounded-lg w-full focus:outline-none' />
        </div>
        <div>
          <label htmlFor="" className='block text-sm lg:text-lg font-semibold py-1'>Email</label>
          <input type="email" name='email' className='bg-theme-light w-full px-3 py-2 rounded-lg focus:outline-none' />
        </div>
        <div>
          <label htmlFor="" className='block text-sm lg:text-lg font-semibold py-1'>Phone number</label>
