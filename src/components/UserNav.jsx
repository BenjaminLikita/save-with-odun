    ...
    {/* <div className='outline-dashed outline-2 sticky top-0'> */}
      ...
      <div className="pt-10 flex flex-col gap-4">
        ...
        <Link to={"/"} onClick={(e) => {
          ...
          className={clsx('flex items-center gap-3 px-5 py-3 border shadow-sm rounded-xl font-medium hover:bg-theme-lighter hover:text-white transition-all duration-500 ')}><FiLogOut />{loggingOut ? "Logging Out" : "Log Out"}</Link>
      </div>
    </div>
  )
}
