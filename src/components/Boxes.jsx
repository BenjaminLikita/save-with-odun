    ...
    return(
        <>
            ...
            <div className='px-5 pt-10 py-5 flex items-center justify-between gap-10'>
                ...
                <button className='bg-theme-color text-white text-xs lg:text-base hover:text-black flex items-center gap-2 rounded-md shadow-sm py-3 px-4 transition-all duration-700 hover:bg-white'
            ...
            </div>
            {
                ...
                <div className='fixed top-[50%] left-[50%] bg-white w-[80%] lg:w-[60%] rounded-2xl shadow-sm p-10 translate-x-[-50%] translate-y-[-50%] z-50'>
