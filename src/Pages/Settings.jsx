...
function Settings() {
  ...
  return (
    <div className='w-[98%] m-auto gap-10 block lg:grid grid-cols-3 lg:mt-2'>
        <UserNav />
        <div className='col-span-2'>
            <div className='bg-[#F3F8F0] py-5 px-3 rounded-2xl shadow-sm'>
                <div>
                    <ul className='w-[100%] lg:w-[60%] m-auto flex items-center justify-between text-[10px] lg:text-sm font-medium'>
                        <button className={clsx('border border-[#F3F8F0] px-[8px] py-2 lg:p-3 rounded-lg hover:bg-theme-lighter hover:text-white  transition-all duration-500', {
